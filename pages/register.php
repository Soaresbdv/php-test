...
<body class="bg-gradient-to-br from-blue-500 to-purple-600 min-h-screen flex items-center justify-center p-6">
    <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <h2 class="text-3xl font-bold text-center text-gray-800 mb-8">Criar Conta</h2>
        ...
        <div class="text-center mt-6">
            <p class="text-gray-600">Já tem conta? 
                <a href="login.php" class="text-blue-500 hover:text-blue-700 font-semibold transition">Faça login aqui</a>
            </p>
        </div>
    </div>
</body>
